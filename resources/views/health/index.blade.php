        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 py-3 wow fadeInUp">
                    ...
                    <a href="{{route('health.about')}} " class="btn btn-primary">Learn More</a>
                </div>
            ...
            <div class="item">
                <div class="card-doctor">
                    <div class="header">
                        ...
                        <img src="{{URL::to('/')}}/img/doctors/{{$doctor->image}}" alt="doctor image">
                        <div class="meta">
                    ...
                    <div class="body">
                        ...
                        <span class="text-sm text-grey">{{$doctor->field->name}}</span>
                    </div>
                </div>
            </div>
            @endforeach
    ...
    <div class="container">
        ...
        <div class="row mt-5">
                ...
                <div class="card-blog">
                    <div class="header">
                        <div class="post-category">
                            <a href="{{route('health.blog-details',['id'=>$blog->id])}}">{{$blog->category->name}}</a>
                        </div>
            ...
            <div class="col-12 text-center mt-4 wow zoomIn">
                <a href="{{route('health.blogs')}}" class="btn btn-primary">Read More</a>
            </div>
